...
int main() {
    ...
    std::cout << "Enviando " << SIZE << " paquetes de entrada con probabilidad 0.5 y bit_entrada = 0\n";
    ...
    simulate_errors(in_stream, out_stream);

    
    std::cout << "\nLeyendo salidas agrupadas de " << K << " en " << K << ":\n";
